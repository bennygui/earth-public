...
function gameVersionHasFalltroughActivation()
{
    $gameStateMgr = \BX\Action\ActionRowMgrRegister::getMgr('game_state');
    return ($gameStateMgr->getGameVersion() >= 1);
}

const EVENT_COMMON_PAYMENT = 1;
const EVENT_COMMON_GAIN = 2;
const EVENT_COMMON_INSTANT = 3;
...
// States: Action Plant, Additional card
const STATE_ACTION_PLANT_PRE_ADDITIONAL = 'STATE_ACTION_PLANT_PRE_ADDITIONAL';
const STATE_ACTION_PLANT_PRE_ADDITIONAL_ID = 407;

const STATE_ACTION_PLANT_ADDITIONAL = 'STATE_ACTION_PLANT_ADDITIONAL';
const STATE_ACTION_PLANT_ADDITIONAL_ID = 408;

const STATE_ACTION_PLANT_ADDITIONAL_CARD = 'STATE_ACTION_PLANT_ADDITIONAL_CARD';
const STATE_ACTION_PLANT_ADDITIONAL_CARD_ID = 409;

// States: Action Plant, Special gain after planting
const STATE_ACTION_PLANT_PRE_SPECIAL_GAIN = 'STATE_ACTION_PLANT_PRE_SPECIAL_GAIN';
const STATE_ACTION_PLANT_PRE_SPECIAL_GAIN_ID = 410;

const STATE_ACTION_PLANT_SPECIAL_GAIN = 'STATE_ACTION_PLANT_SPECIAL_GAIN';
const STATE_ACTION_PLANT_SPECIAL_GAIN_ID = 411;
...
const STATE_CONVERT_SELECT_USE_SEED = 'STATE_CONVERT_SELECT_USE_SEED';
const STATE_CONVERT_SELECT_USE_SEED_ID = 1002;
const STATE_CONVERT_SELECT_CREATE_SEED = 'STATE_CONVERT_SELECT_CREATE_SEED';
const STATE_CONVERT_SELECT_CREATE_SEED_ID = 1003;
const STATE_CONVERT_SELECT_USE_SEED_GAIN = 'STATE_CONVERT_SELECT_USE_SEED_GAIN';
const STATE_CONVERT_SELECT_USE_SEED_GAIN_ID = 1004;

// States: Others
const STATE_CONFIRM_END_PHASE = 'STATE_CONFIRM_END_PHASE';
const STATE_CONFIRM_END_PHASE_ID = 1101;

const STATE_PRE_GAME_ENDING_LAST_CHANCE = 'STATE_PRE_GAME_ENDING_LAST_CHANCE';
const STATE_PRE_GAME_ENDING_LAST_CHANCE_ID = 1202;
...
// States: End Turn
const STATE_PRE_END_TURN = 'STATE_PRE_END_TURN';
const STATE_PRE_END_TURN_ID = 1599;

const STATE_ENTER_END_TURN = 'STATE_ENTER_END_TURN';
const STATE_ENTER_END_TURN_ID = 1598;

const STATE_END_TURN = 'STATE_END_TURN';
const STATE_END_TURN_ID = 1500;
const STATE_END_TURN_CHOOSE = 'STATE_END_TURN_CHOOSE';
const STATE_END_TURN_CHOOSE_ID = 1501;
const STATE_END_TURN_PLACE_SPROUT = 'STATE_END_TURN_PLACE_SPROUT';
const STATE_END_TURN_PLACE_SPROUT_ID = 1502;
const STATE_END_TURN_CHOOSE_END_TURN_EVENT = 'STATE_END_TURN_CHOOSE_END_TURN_EVENT';
const STATE_END_TURN_CHOOSE_END_TURN_EVENT_ID = 1503;
const STATE_END_TURN_EVENT = 'STATE_END_TURN_EVENT';
const STATE_END_TURN_EVENT_ID = 1504;
const STATE_END_TURN_EVENT_CHOOSE = 'STATE_END_TURN_EVENT_CHOOSE';
const STATE_END_TURN_EVENT_CHOOSE_ID = 1505;
const STATE_END_TURN_EVENT_AFTER = 'STATE_END_TURN_EVENT_AFTER';
const STATE_END_TURN_EVENT_AFTER_ID = 1506;
...
const NTF_PLAYER_GAIN_SEED = 'NTF_PLAYER_GAIN_SEED';
const NTF_PLAYER_PAY_SEED = 'NTF_PLAYER_PAY_SEED';
const NTF_UPDATE_PLAYER_EXCHANGE = 'NTF_UPDATE_PLAYER_EXCHANGE';
...
const GAME_OPTION_EXPANSION = 'GAME_OPTION_EXPANSION';
const GAME_OPTION_EXPANSION_ID = 103;
const GAME_OPTION_EXPANSION_VALUE_BASE_GAME = 0;
const GAME_OPTION_EXPANSION_VALUE_ABUNDANCE = 1;

function gameHasExpansionAbundance()
{
    return (\BX\BGAGlobal\GlobalMgr::getGlobal(GAME_OPTION_EXPANSION_ID) == GAME_OPTION_EXPANSION_VALUE_ABUNDANCE);
}

const GAME_OPTION_SHOW_SCORE = 'GAME_OPTION_SHOW_SCORE';
const GAME_OPTION_SHOW_SCORE_ID = 104;
const GAME_OPTION_SHOW_SCORE_VALUE_HIDDEN = 0;
const GAME_OPTION_SHOW_SCORE_VALUE_VISIBLE = 1;

function isGameOptionScoreVisible()
{
    return (\BX\BGAGlobal\GlobalMgr::getGlobal(GAME_OPTION_SHOW_SCORE_ID) == GAME_OPTION_SHOW_SCORE_VALUE_VISIBLE);
}
...
// Abundance
const STATS_PLAYER_NB_GAINED_SEEDS_TOTAL = 'STATS_PLAYER_NB_GAINED_SEEDS_TOTAL';
const STATS_PLAYER_NB_LEAFS_CONVERTED_TOTAL = 'STATS_PLAYER_NB_LEAFS_CONVERTED_TOTAL';
const STATS_PLAYER_NB_GERMINATE_TOTAL = 'STATS_PLAYER_NB_GERMINATE_TOTAL';
const STATS_PLAYER_NB_SPROUTS_PLACED_ON_BOARD_BY_PLAYER = 'STATS_PLAYER_NB_SPROUTS_PLACED_ON_BOARD_BY_PLAYER';
const STATS_PLAYER_NB_SPROUTS_PLACED_ON_BOARD_BY_OTHERS = 'STATS_PLAYER_NB_SPROUTS_PLACED_ON_BOARD_BY_OTHERS';
const STATS_PLAYER_NB_SPROUTS_PLACED_FROM_BOARD = 'STATS_PLAYER_NB_SPROUTS_PLACED_FROM_BOARD';
